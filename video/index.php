...
<link rel='stylesheet prefetch' href='http://cdn.jsdelivr.net/jquery.slick/1.5.9/slick.css'>
		<script src="video/js/modernizr.custom.js"></script>
		<script src="video/js/javascript.js"></script>
	</head>
...
<div id="text_rp">
 ...
 <li style="margin-right: 100px; color: #cfb53b">ВКЛЮЧАЙСЯ</li>    <li>  <center><a   href="/">Главная</a></li> <li><a style="color: #cfb53b"  href="/video/">Видео</a></center> </li> <li><a style="margin-right: 300px" href="/subscribe.php">Подписка</a></center> </li>  <li> <?php
session_start();
...
require_once("includes/videomenu.php")
