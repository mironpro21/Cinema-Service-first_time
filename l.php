...
require_once("video/includes/load.php")
...
<div id="text_rp">
 ...
 <li style="margin-right: 100px; color: #cfb53b">ВКЛЮЧАЙСЯ</li>    <li>  <center><a   href="/">Главная</a></li> <li><a  href="/video/">Видео</a></center> </li> <li><a style="margin-right: 300px" href="/subscribe.php">Подписка</a></center> </li> 
...
if(empty($_SESSION['login'])){
    if($_GET['p']==''){
		...
		<center>
		<br><br>
        <li><h2><a href='l.php?p=login'>Авторизация</a></h2></li>
        <li>/</li>
        <li><h2><a href='l.php?p=register'>Регистрация</a></h2></li>
		</center>
        ";
    ...
    echo "
    <br>
    <a href='logout.php' class='button special'>Выход</a>";
}
...
<hr width="12%" color="#cfb53b" align="center" size="10">

<br>
<div id="text_rp">
<center>ВКЛЮЧАЙСЯ - Интернет-Кинотеатр 2018-2019</center>
<br><br>
</div>
