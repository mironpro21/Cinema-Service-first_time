...
<div id="text_rp">
 ...
 <li style="margin-right: 130px; color: #cfb53b">ВКЛЮЧАЙСЯ</li>    <li>  <center><a style="color: #cfb53b"   href="/">Главная</a></li> <li><a style="margin-right: 678px;"  href="/video/">Видео</a></center> </li>   <li> <?php
session_start();
...
<center><hr width="9%" color="#cfb53b" align="left" size="10"></center>
</ul>
...
<center><div id="player"><object id="photoplayer7" type="application/x-shockwave-flash" data="http://kino.local/js/uppod.swf" width="1100" height="365"><param name="bgcolor" value="#ffffff" /><param name="allowFullScreen" value="true" /><param name="allowScriptAccess" value="always" /><param name="movie" value="http://kino.local/js/playerjs.js" /></object>
<div id="photoplayer7"></div><script type="text/javascript">var flashvars = {"comment":"Домашний Арест","st":"http://kino.local/player/st/photo258-18.txt","file":"https://showspy.ru/wp-content/uploads/2018/01/domashnij-arest-poster.jpg"};var params = {bgcolor:"#ffffff",  allowFullScreen:"true", allowScriptAccess:"always",id:"photoplayer7"}; new swfobject.embedSWF("http://kino.local/js/uppod.swf", "photoplayer7", "700", "365", "9.0.115.0", false, flashvars, params);</script>




<b>Лучшие выпуски и видео</b>
</center>
   


<hr width="30%" color="#cfb53b" align="center" size="10">
...
require_once("video/includes/videomenu.php")
